...
jQuery.keyboard.layouts['ms-Albanian'] = {
	...
	"normal": [
		...
		"{lock} a s d f g h j k l \u00eb [ {enter}",
	...
	alt: [
		...
		"{lock} \u0111 \u0110 [ ] {empty} {empty} \u0142 \u0141 $ \u00df \u00a4 {enter}",
...
jQuery.keyboard.layouts['ms-Azeri Cyrillic'] = {
	...
	"normal" : [
		...
		"{lock} \u0444 \u044b \u0432 \u0430 \u043f \u0440 \u043e \u043b \u0434 \u0436 \u049d {enter}",
...
jQuery.keyboard.layouts['ms-Azeri Latin'] = {
	...
	"normal" : [
		...
		"{lock} a s d f g h j k l \u0131 \u0259 {enter}",
	...
	"shift" : [
		...
		"{lock} A S D F G H J K L I \u018f {enter}",
		"{shift} / Z X C V B N M \u00c7 \u015e {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Bengali'] = {
	...
	"lang" : ["bn"],
	"normal" : [
		"{empty} 1 2 3 4 5 6 7 8 9 0 - \u09c3 {bksp}",
		"{tab} \u09cc \u09c8 \u09be \u09c0 \u09c2 \u09ac \u09b9 \u0997 \u09a6 \u099c \u09a1 \u09bc {empty}",
		"{lock} \u09cb \u09c7 \u09cd \u09bf \u09c1 \u09aa \u09b0 \u0995 \u09a4 \u099a \u099f {enter}",
		"{shift} {empty} \u0982 \u09ae \u09a8 \u09ac \u09b2 \u09b8 , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"{empty} {empty} {empty} \u09cd\u09b0 \u09b0\u09cd \u099c\u09cd\u09b0 \u09a4\u09cd\u09b7 \u0995\u09cd\u09b0 \u09b6\u09cd\u09b0 ( ) \u0983 \u098b {bksp}",
		"{tab} {empty} \u0994 \u0990 \u0986 \u0988 \u098a \u09ad \u0999 \u0998 \u09a7 \u099d \u09a2 \u099e",
		"{lock} \u0993 \u098f \u0985 \u0987 \u0989 \u09ab {empty} \u0996 \u09a5 \u099b \u09a0 {enter}",
		"{shift} {empty} {empty} \u0981 \u09a3 {empty} {empty} {empty} \u09b6 \u09b7 { {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
		"{empty} \u09e7 \u09e8 \u09e9 \u09ea \u09eb \u09ec \u09ed \u09ee \u09ef \u09e6 {empty} \u09e2 {bksp}",
		"{tab} {empty} \u09d7 {empty} {empty} \u09e3 {empty} {empty} {empty} {empty} {empty} {empty} \u09dc {empty}",
		"{lock} \u09f4 \u09f6 \u09f8 \u09e2 {empty} {empty} \u09f0 {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} \u09fa {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift":[
		"{empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u09e0 {bksp}",
		"{tab} {empty} {empty} {empty} {empty} \u09e1 {empty} {empty} {empty} {empty} {empty} {empty} \u09dd {empty}",
		"{lock} \u09f5 \u09f7 \u09f9 \u098c {empty} {empty} \u09f1 {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Bengali - INSCRIPT (Legacy)'] = {
	...
	"lang" : ["bn"],
	"normal" : [
		"{empty} \u09e7 \u09e8 \u09e9 \u09ea \u09eb \u09ec \u09ed \u09ee \u09ef \u09e6 - \u09c3 {bksp}",
		"{tab} {empty} \u09cc \u09c8 \u09be \u09c0 \u09c2 \u09ac \u09b9 \u0997 \u09a6 \u099c \u09a1 \u09bc",
		"{lock} \u09cb \u09c7 \u09cd \u09bf \u09c1 \u09aa \u09b0 \u0995 \u09a4 \u099a \u099f {enter}",
		"{shift} {empty} \u0982 \u09ae \u09a8 \u09ac \u09b2 \u09b8 , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"{empty} ! @ {empty} \u09b0\u09cd \u099c\u09cd\u099e \u09a4\u09cd\u09b0 \u0995\u09cd\u09b7 \u09b6\u09cd\u09b0 ( ) \u0983 \u098b {bksp}",
		"{tab} \u0994 \u0990 \u0986 \u0988 \u098a \u09ad \u0999 \u0998 \u09a7 \u099d \u09a2 \u099e {empty}",
		"{lock} \u0993 \u098f \u0985 \u0987 \u0989 \u09ab {empty} \u0996 \u09a5 \u099b \u09a0 {enter}",
		"{shift} \u0981 \u09a3 {empty} {empty} {empty} \u09b6 \u09b7 {empty} / {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Czech'] = {
	...
	"alt" : [
		"{empty} ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u02d9 \u00b4 \u02dd \u00a8 \u00b8 {bksp}",
		"{tab} \\ | \u20ac {empty} ë ÿ ü ï ö ä \u00f7 \u00d7 \u00a4",
		"{lock} \u0111 \u0110 [ ] {empty} {empty} \u0142 \u0141 $ \u00df {empty} {enter}",
		"{shift} {empty} {empty} # & @ { } {empty} < > {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Czech (QWERTY)'] = {
	...
	"alt" : [
		"` ! @ # $ % ^ & * ( ) - = {bksp}",
		"{tab} {empty} {empty} \u20ac {empty} {empty} {empty} {empty} {empty} {empty} {empty} [ ] \\",
		"{lock} {empty} {empty} ë ÿ ü ï ö ä ; \u00a4 {enter}",
	...
	"alt-shift" : [
		...
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} { } |",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} : ^ {enter}",
...
jQuery.keyboard.layouts['ms-Czech Programmers'] = {
	...
	"alt" : [
		...
		"{lock} {empty} {empty} ë ÿ ü ï ö ä \u016f \u00a7 {empty} {enter}",
		"{shift} \u00df {empty} {empty} {empty} {empty} {empty} {empty} {empty} ? : {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		...
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \" ! {empty} {enter}",
		"{shift} \u02dd {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00d7 \u00f7 {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Danish'] = {
	...
	"alt" : [
		...
		"{tab} {empty} {empty} \u20AC ë ÿ ü ï ö ä {empty} {empty} {empty} ~",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} \\ < > {empty} {empty} {empty} \u00B5 {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Dutch'] = {
	...
	"alt" : [
		"\u00AC \u00B9 \u00B2 \u00B3 \u00BC \u00BD \u00BE \u00A3 { } {empty} \\ \u00B8 {bksp}",
		"{tab} {empty} {empty} \u20AC \u00B6 ë ÿ ü ï ö ä {empty} {empty} {empty}",
		"{lock} \u00DF {empty} {empty} - = {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} \u00A6 \u00AB \u00BB \u00A2 {empty} {empty} \u00B5 {empty} \u00B7 {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Estonian'] = {
	...
	"alt" : [
		"{empty} {empty} @ \u00a3 $ \u20ac {empty} { [ ] } \\ {empty} {bksp}",
		"{tab} {empty} {empty} \u20ac {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00a7 \u00bd",
		"{lock} \u0161 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} ^ {enter}",
		"{shift} | \u017e < > {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"{empty} {empty} @ \u00a3 $ {empty} {empty} { [ ] } \\ {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00a7 \u00bd",
		"{lock} \u0160 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} ^ {enter}",
		"{shift} | \u017d {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Finnish'] = {
	...
	"alt" : [
		...
		"{tab} {empty} {empty} {empty} \u20AC ë ÿ ü ï ö ä [ ] ~ ",
		"{lock} < > {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} | {empty} {empty} {empty} {empty} {empty} \u00B5 {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Greek'] = {
	...
	"alt" : [
		...
		"{tab} {empty} {empty} {empty} \u20AC \u00AE {empty} \u00A5 {empty} {empty} {empty} {empty} \u00AB \u00BB",
		"{lock} < > {empty} {empty} {empty} {empty} {empty} {empty} \u0385 {empty} \u00AC {enter}",
		"{shift} {empty} {empty} \u00A9 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Greek (319)'] = {
	...
	"alt" : [
		"{empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} \u20AC {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty}",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0385 {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Greek Latin'] = {
	...
	"alt" : [
		...
		"{lock} \u00E1 \u00DF \u00F0 {empty} {empty} {empty} {empty} {empty} \u00F8 \u00B6 \u00B4 \u00AC {enter}",
	...
	"alt-shift" : [
		...
		"{lock} \u00C1 \u00A7 \u00D0 {empty} {empty} {empty} {empty} {empty} \u00D8 \u00B0 \u00A8 \u00A6 {enter}",
...
jQuery.keyboard.layouts['ms-Hebrew'] = {
	...
	"alt" : [
		...
		"{lock} {empty} {empty} {empty} {empty} {empty} \u05f2 \u05f1 {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Hungarian'] = {
	...
	"alt" : [
		"{empty} ~ \u02C7 ^ \u02D8 \u00B0 \u02DB ` \u02D9 \u00B4 \u02DD \u00A8 \u00B8 {bksp}",
		"{tab} \\ | \u00C4 {empty} * - _ \u20AC \u00CD {empty} {empty} \u00F7 \u00D7",
		"{lock} \u00E4 \u0111 \u0110 [ ] \u00ED \u0142 \u0141 $ \u00DF \u00A4 {enter}",
		"{shift} < > # & @ { } < ; > {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Hungarian 101-key'] = {
	...
	"alt" : [
		...
		"{lock} \u00E4 \u0111 \u0110 [ ] {empty} \u00ED \u0142 \u0141 $ \u00DF \\ {enter}",
		"{shift} < > # & @ { } < ; > * {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts["ms-Japanese Hiragana"] = {
	...
	"normal" : [
		...
		"{lock} \u3061:Ti \u3068:To \u3057:Si \u306f:Ha \u304D:Ki \u304f:Ku \u307e:Ma \u306e:No \u308a:Ri \u308c:Re \u3051:Ke {enter}",
	...
	"meta3" : [
		...
		"{lock} \u30c1:Ti \u30c8:To \u30b7:Si \u30cf:Ha \u30ad:Ki \u30af:Ku \u30de:Ma \u30ce:No \u30ea:Ri \u30ec:Re \u30b1:Ke {enter}",
		"{shift} \u30c4:Tu \u30b5:Sa \u30bd:So \u30d2:Hi \u30b3:Ko \u30df:Mi \u30e2:Mo \u30cd:Ne \u30eb:Ru {default} {shift}",
		"{accept} {space} {meta2} {meta1:\u5168:half} {cancel}"
	],
	"meta3-shift" : [
		...
		"{accept} {space} {default} {meta2} {meta1:\u5168:half} {cancel}"
	],
	// // Katakana half width
	// "meta4" : [
	...
	// 	"{lock} \uff81:Ti \uff84:To \uff7c:Si \uff8a:Ha \uff77:Ki \uff78:Ku \uff8f:Ma \uff89:No \uff98:Ri \uff9a:Re \uff79:Ke {enter}",
...
jQuery.keyboard.layouts['ms-Latvian'] = {
	...
	"normal" : [
		...
		"{lock} \u0161 u s i l d a t e c \u00b4 {enter}",
	...
	"alt" : [
		...
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u20ac {empty} \u00b4 {enter}",
		"{shift} \\ x {empty} \u0137 {empty} \u00f5 {empty} < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"{empty} {empty} @ # $ ~ ^ \u00b1 {empty} {empty} {empty} \u2014 ; {bksp}",
		"{tab} Q \u0122 {empty} \u0156 W Y {empty} {empty} {empty} {empty} { } {empty}",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00a8 {enter}",
		"{shift} | {empty} X \u0136 {empty} \u00d5 {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Latvian (QWERTY)'] = {
	...
	"alt" : [
		...
		"{lock} \u0101 \u0161 {empty} {empty} \u0123 {empty} {empty} \u0137 \u013c {empty} \u00b4 {enter}",
...
jQuery.keyboard.layouts['ms-Lithuanian IBM'] = {
	...
	"normal" : [
		...
		"{lock} a s d f g h j k l \u0173 \u0117 {enter}",
...
jQuery.keyboard.layouts['ms-Lithuanian Standard'] = {
	...
	"normal" : [
		...
		"{lock} a s d \u0161 g h j k l \u0173 \u0117 {enter}",
...
jQuery.keyboard.layouts['ms-Luxembourgish'] = {
	...
	"normal" : [
		...
		"{lock} a s d f g h j k l \u00e9 \u00e0 {enter}",
		"{shift} < y x c v b n m , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
...
jQuery.keyboard.layouts['ms-Macedonian (FYROM)'] = {
	...
	"alt" : [
		...
		"{lock} {empty} {empty} [ ] {empty} {empty} {empty} {empty} \u040b \u045b {enter}",
		"{shift} {empty} {empty} {empty} {empty} @ { } \u00a7 {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Malayalam'] = {
	...
	"alt-shift" : [
		...
		"{lock} {empty} \u0d0c {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Maltese 47-Key'] = {
	...
	"alt" : [
		...
		"{lock} \u00e0 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
jQuery.keyboard.layouts['ms-Mongolian (Mongolian Script)'] = {
	...
	"normal" : [
		...
		"{lock} \u1820 \u1830 \u1833 \u1839 \u182d \u182c \u1835 \u183a \u182f ; \u180b {enter}",
	...
	"shift" : [
		...
		"{lock} {empty} {empty} {empty} {empty} \u183e {empty} \u183b \u1840 \u1804 \u180c {enter}",
...
jQuery.keyboard.layouts['ms-Nepali'] = {
	...
	"normal" : [
		...
		"{lock} \u092c \u0915 \u092e \u093e \u0928 \u091c \u0935 \u092a \u093f \u0938 \u0941 {enter}",
	...
	"shift" : [
		...
		"{lock} \u092c\u094d \u0915\u094d \u092e\u094d \u0901 \u0928\u094d \u091c\u094d \u0935\u094d \u092a\u094d \u0940 \u0938\u094d \u0942 {enter}",
...
jQuery.keyboard.layouts['ms-Norwegian with Sami'] = {
	...
	"alt" : [
		...
		"{lock} \u00e1 \u0161 \u0111 \u01e5 \u01e7 \u021f {empty} \u01e9 {empty} \u00f6 \u00e4 {enter}",
...
jQuery.keyboard.layouts['ms-Oriya'] = {
	...
	"shift" : [
		...
		"{lock} \u0b13 \u0b0f \u0b05 \u0b07 \u0b09 \u0b2b {empty} \u0b16 \u0b25 \u0b1b \u0b20 {enter}",
	...
	"alt-shift" : [
		...
		"{lock} {empty} {empty} \u0b0c {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
...
jQuery.keyboard.layouts['ms-Pashto (Afghanistan)'] = {
	...
	"normal" : [
		...
		"{lock} \u0634 \u0633 \u06cc \u0628 \u0644 \u0627 \u062a \u0646 \u0645 \u06a9 \u06ab {enter}",
	...
	"alt" : [
		...
		"{lock} {empty} {empty} \u06d2 \u06ba \u06b7 \u0625 \u0679 > < \u0643 \u06af {enter}",
...
jQuery.keyboard.layouts['ms-Polish (214)'] = {
	...
	"normal" : [
		"\u02DB 1 2 3 4 5 6 7 8 9 0 + ' {bksp}",
		"{tab} q w e r t z u i o p \u017C \u015B \u00F3",
		"{lock} a s d f g h j k l \u0142 \u0105 {enter}",
		"{shift} y x c v b n m , . - {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"\u00B7 ! \" # \u00A4 % & / ( ) = ? * {bksp}",
		"{tab} Q W E R T Z U I O P \u0144 \u0107 \u017A",
		"{lock} A S D F G H J K L \u0141 \u0119 {enter}",
		"{shift} Y X C V B N M ; : _ {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
		"{empty} ~ \u02C7 ^ \u02D8 \u00B0 \u02DB ` \u00B7 \u00B4 \u02DD \u00A8 \u00B8 {bksp}",
		"{tab} < > \\ \u00A6 {empty} {empty} {empty} \u20AC {empty} {empty} {empty} \u00F7 \u00D7",
		"{lock} \u0111 \u0110 {empty} {empty} {empty} {empty} {empty} {empty} $ \u00DF {empty} {enter}",
		"{shift} {empty} {empty} {empty} @ { } \u00A7 < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Polish (Programmers)'] = {
	...
	"alt" : [
		...
		"{lock} \u0105 \u015B {empty} {empty} {empty} {empty} {empty} {empty} \u0142 {empty} {empty} {empty} {enter}",
...
jQuery.keyboard.layouts['ms-Portuguese'] = {
	...
	"normal" : [
		"\\ 1 2 3 4 5 6 7 8 9 0 ' \u00AB {bksp}",
		"{tab} q w e r t y u i o p + \u00B4 ~",
		"{lock} a s d f g h j k l \u00E7 \u00BA  {enter}",
		"{shift}  z x c v b n m , . - {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"| ! \" # $ % & / ( ) = ? \u00BB {bksp}",
		"{tab} Q W E R T Y U I O P * ` ^",
		"{lock} A S D F G H J K L \u00C7 \u00AA  {enter}",
		"{shift}  Z X C V B N M ; : _ {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
...
jQuery.keyboard.layouts['ms-Portuguese (Brazilian ABNT)'] = {
	...
	"alt" : [
		...
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00BA {enter}",
		"{shift} {empty} {empty} {empty} \u20A2 {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00B0 {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Punjabi'] = {
	...
	"normal" : [
		"{empty} 1 2 3 4 5 6 7 8 9 0 - {empty} {bksp}",
		"{tab} \u0a4c \u0a48 \u0a3e \u0a40 \u0a42 \u0a2c \u0a39 \u0a17 \u0a26 \u0a1c \u0a21 \u0a3c {empty}",
		"{lock} \u0a4b \u0a47 \u0a4d \u0a3f \u0a41 \u0a2a \u0a30 \u0a15 \u0a24 \u0a1a \u0a1f {enter}",
		"{shift} {empty} \u0a70 \u0a2e \u0a28 \u0a35 \u0a32 \u0a38 , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"\u0a4d\u0a39 \u0a4d\u0a35 \u0a4d\u0a2f \u0a4d\u0a30 \u0a71 {empty} {empty} {empty} {empty} ( ) {empty} {empty} {bksp}",
		"{tab} \u0a14 \u0a10 \u0a06 \u0a08 \u0a0a \u0a2d \u0a19 \u0a18 \u0a27 \u0a1d \u0a22 \u0a1e {empty}",
		"{lock} \u0a13 \u0a0f \u0a05 \u0a07 \u0a09 \u0a2b \u0a5c \u0a16 \u0a25 \u0a1b \u0a20 {enter}",
		"{shift} {empty} \u0a02 \u0a23 {empty} \u0a72 \u0a33 \u0a36 {empty} \u0964 / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
		"{empty} \u0a67 \u0a68 \u0a69 \u0a6a \u0a6b \u0a6c \u0a6d \u0a6e \u0a6f \u0a66 {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0a5a {empty} \u0a5b \u0a5c {empty}",
		"{lock} {empty} {empty} {empty} {empty} {empty} \u0a5e {empty} \u0a59 {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} \u0a73 {empty} {empty} {empty} \u0965 {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"{empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty}",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} \u0a74 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Romanian (Legacy)'] = {
	...
	"normal" : [
		...
		"{lock} a s d f g h j k l \u015f \u0163 {enter}",
		"{shift} < y x c v b n m , . {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
	...
	"alt" : [
		" ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u00b7 \u00b4 \u02dd \u00a8 \u00b8 {empty} {bksp}",
		"{tab} \\ | {empty}  {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00f7 \u00d7 {empty}",
		"{lock} {empty} \u0111 \u0110 {empty} {empty} {empty} {empty} \u0142 \u0141 $ \u00df {enter}",
		"{shift} \u001c {empty} {empty} @ { } \u00a7 < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Romanian (Programmers)'] = {
	...
	"alt" : [
		...
		"{lock} \u0103 \u0219 \u0111 {empty} {empty} {empty} {empty} {empty} \u0142 {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} \u00a9 {empty} {empty} {empty} {empty} \u00ab \u00bb {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
jQuery.keyboard.layouts['ms-Romanian (Standard)'] = {
	...
	"alt" : [
		"` ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u02d9 \u00b4 \u02dd \u00a8 \u00b8 {bksp}",
		"{tab} {empty} {empty} \u20ac {empty} {empty} {empty} {empty} {empty} {empty} \u00a7 [ ] \\",
		"{lock} \u00df \u0111 {empty} {empty} {empty} {empty} {empty} \u0142 ; ' {enter}",
		"{shift} {empty} {empty} {empty} \u00a9 {empty} {empty} {empty} {empty} < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"~ {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u2013 \u00b1 {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} { } |",
		"{lock} {empty} \u0110 {empty} {empty} {empty} {empty} {empty} \u0141 : \" {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00ab \u00bb {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Sami Extended Finland-Sweden'] = {
	...
	"alt" : [
		...
		"{lock} \u00e2 {empty} {empty} {empty} \u01e7 \u01e5 {empty} \u01e9 {empty} \u00f8 \u00e6 {enter}",
...
jQuery.keyboard.layouts['ms-Sami Extended Norway'] = {
	...
	"alt" : [
		"{empty} {empty} @ \u00a3 $ \u20ac {empty} { [ ] } {empty} \u00b4 {bksp}",
		"{tab} q w \u20ac {empty} {empty} y {empty} \u00ef \u00f5 {empty} \u00a8 ~ '",
		"{lock} \u00e2 {empty} {empty} {empty} \u01e7 \u01e5 {empty} \u01e9 {empty} \u00f6 \u00e4 {enter}",
		"{shift} \u01ef \u0292 x {empty} {empty} {empty} {empty} \u00b5 < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
jQuery.keyboard.layouts['ms-Serbian (Latin)'] = {
	...
	"alt" : [
		"{empty} ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u02d9 \u00b4 \u02dd \u00a8 \u00b8 {bksp}",
		"{tab} \\ | \u20ac {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00f7 \u00d7 \u00a4",
		"{lock} {empty} {empty} [ ] {empty} {empty} \u0142 \u0141 {empty} \u00df {enter}",
		"{shift} {empty} {empty} {empty} {empty} @ { } \u00a7 < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Serbian (Cyrillic)'] = {
	...
	"normal" : [
		"` 1 2 3 4 5 6 7 8 9 0 ' + {bksp}",
		"{tab} \u0459 \u045a \u0435 \u0440 \u0442 \u0437 \u0443 \u0438 \u043e \u043f \u0448 \u0452 \u0436",
		"{lock} \u0430 \u0441 \u0434 \u0444 \u0433 \u0445 \u0458 \u043a \u043b \u0447 \u045b {enter}",
		"{shift} < \u0455 \u045f \u0446 \u0432 \u0431 \u043d \u043c , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
...
jQuery.keyboard.layouts['ms-Sinhala'] = {
	...
	"normal" : [
		...
		"{lock} \u0dca \u0dd2 \u0dcf \u0dd9 \u0da7 \u0dba \u0dc0 \u0db1 \u0d9a \u0dad . {enter}",
	...
	"shift" : [
		...
		"{lock} \u0ddf \u0dd3 \u0dd8 \u0dc6 \u0da8 \u0dca{ZWJ}\u0dba \u0dc5\u0dd4 \u0dab \u0d9b \u0dae , {enter}",
	...
	"alt" : [
		"{empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty}",
		"{lock} \u0df3 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0df4 {enter}",
...
jQuery.keyboard.layouts['ms-Sinhala - Wij 9'] = {
	...
	"alt" : [
		...
		"{lock} \u0df3 \u0ddd {empty} {empty} {empty} {empty} {ZWJ} {empty} {empty} {empty} \u0df4 {enter}",
...
jQuery.keyboard.layouts['ms-Slovak'] = {
	...
	"normal" : [
		...
		"{lock} a s d f g h j k l \u00f4 \u00a7 {enter}",
		"{shift} & y x c v b n m , . {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
	...
	"alt" : [
		"{empty} ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u02d9 \u00b4 \u02dd \u00a8 \u00b8 {bksp}",
		"{tab} \\ | \u20ac {empty} {empty} {empty} {empty} {empty} {empty} ' \u00f7 \u00d7 \u00a4",
		"{lock} \u0111 \u0110 [ ] {empty} {empty} {empty} \u0142 \u0141 $ \u00df {enter}",
		"{shift} < > # & @ { } {empty} < >  {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Slovenian'] = {
	...
	"alt" : [
		"{empty} ~ \u02c7 ^ \u02d8 \u00b0 \u02db ` \u02d9 \u00b4 \u02dd \u00a8 \u00b8 {bksp}",
		"{tab} \\ | \u20ac {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00f7 \u00d7 \u00a4",
		"{lock} {empty} {empty} {empty} {empty} [ ] {empty} \u0142 \u0141 {empty} \u00df {enter}",
		"{shift} {empty} {empty} {empty} @ { } \u00a7 < > {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Spanish'] = {
	...
	"alt" : [
		"\\ | @ # ~ \u20AC \u00AC {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} \u20AC -  _ {empty} {empty} {empty} {empty} {empty} [ ]",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} { } {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
...
jQuery.keyboard.layouts['ms-Spanish Variation'] = {
	...
	"normal" : [
		"' 1 2 3 4 5 6 7 8 9 0 - \u00A8 {bksp}",
		"{tab} q w e r t y u i o p \u00F7 `",
		"{lock} a s d f g h j k l \u00F1 \u00E7 \u00B4 {enter}",
		"{shift} < z x c v b n m , . = {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
...
jQuery.keyboard.layouts['ms-Swedish with Sami'] = {
	...
	"alt" : [
		"{empty} {empty} @ \u00a3 $ \u20ac {empty} { [ ] } \\ {empty} {bksp}",
		"{tab} \u00e2 {empty} \u20ac {empty} \u0167 {empty} {empty} \u00ef \u00f5 {empty} {empty} ~ {empty}",
		"{lock} \u00e1 \u0161 \u0111 \u01e5 \u01e7 \u021f {empty} \u01e9 {empty} \u00f8 \u00e6 {enter}",
...
jQuery.keyboard.layouts['ms-Swedish'] = {
	...
	"alt" : [
		"{empty} {empty} @ \u00A3 $ \u20AC {empty} { [ ] } \\ {empty} {bksp}",
		"{tab} {empty} {empty} {empty} \u20AC {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} ~",
		"{lock} - _ {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} | {empty} {empty} {empty} {empty} {empty} \u00B5 {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Swedish with Sami'] = {
	...
	"alt" : [
		...
		"{lock} \u00E1 \u0161 \u0111 \u01e5 \u01E7 \u021F {empty} \u01e9 {empty} \u00F8 \u00E6 {empty} {enter}",
		"{shift} | \u017E {empty} \u010d \u01EF \u0292 \u014B \u00B5 {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
jQuery.keyboard.layouts['ms-Syriac'] = {
	...
	"normal" : [
		...
		"{lock} \u072b \u0723 \u071d \u0712 \u0720 \u0710 \u072c \u0722 \u0721 \u071f \u071b {enter}",
	...
	"shift" : [
		...
		"{lock} \u0731 \u0734 \u0737 \u073b \u073e \u0711 \u0640 \u0324 \u0331 \u0323 \u0330 {enter}",
	...
	"alt" : [
		...
		"{lock} \u0650 \u064d {empty} \u0621 \u0655 \u0670 \u0748 \u0744 \u0746 {empty} {empty} {enter}",
...
jQuery.keyboard.layouts['ms-Syriac Phonetic'] = {
	...
	"normal" : [
		...
		"{lock} \u0710 \u0723 \u0715 \u0714 \u0713 \u0717 \u071b \u071f \u0720 \u071a \u071e {enter}",
...
jQuery.keyboard.layouts['ms-Tajik'] = {
	...
	"normal" : [
		...
		"{lock} \u0444 \u04b7 \u0432 \u0430 \u043f \u0440 \u043e \u043b \u0434 \u0436 \u044d {enter}",
...
jQuery.keyboard.layouts['ms-Tamil'] = {
	...
	"shift" : [
		...
		"{lock} \u0b93 \u0b8f \u0b85 \u0b87 \u0b89 \u0baa \u0bb1 \u0b95 \u0ba4 \u0b9a \u0b9f {enter}",
...
jQuery.keyboard.layouts['ms-Tatar'] = {
	...
	"normal" : [
		...
		"{lock} \u0444 \u044B \u0432 \u0430 \u043F \u0440 \u043E \u043B \u0434 \u04A3 \u044D \\ {enter}",
	...
	"alt" : [
		...
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0436 ' {empty} {enter}",
	...
	"alt-shift" : [
		...
		"{tab} {empty} \u0426 {empty} {empty} {empty} {empty} {empty} {empty} \u0429 {empty} {empty} \u042A",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0416 {empty} {empty} {enter}",
...
jQuery.keyboard.layouts['ms-Telugu'] = {
	...
	"alt" : [
		...
		"{lock} \u0c55 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		...
		"{lock} {empty} {empty} \u0c0c {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Thai Pattachote'] = {
	...
	"normal" : [
		...
		"{lock} \u0E49 \u0E17 \u0E07 \u0E01 \u0E31 \u0E35 \u0E32 \u0E19 \u0E40 \u0E44 \u0E02 {enter}",
	...
	"shift" : [
		...
		"{lock} \u0E4B \u0E18 \u0E33 \u0E13 \u0E4C \u0E37 \u0E1C \u0E0A \u0E42 \u0E06 \u0E11 {enter}",
...
jQuery.keyboard.layouts['ms-Turkish F'] = {
	...
	"normal" : [
		...
		"{lock} u i e a \u00FC t k m l y \u015F {enter}",
	...
	"shift" : [
		...
		"{lock} U \u0130 E A \u00DC T K M L Y \u015E {enter}",
		"{shift} J \u00D6 V C \u00C7 Z S B : ; {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
		"\u00AC \u00B9 \u00B2 # \u00BC \u00BD \u00BE { [ ] } \u005C | {bksp}",
		"{tab} @ <  > \u00B6 {empty} {empty} \u00A5 {empty} {empty} \u00F8 \u00A3 \u00A8 ~",
		"{lock} \u00E6 \u00DF \u20AC {empty} {empty} {empty} {empty} {empty} \u00B4 {empty} ` {enter}",
		"{shift} | \u00AB \u00BB \u00A2 {empty} {empty} \u00B5 \u00D7 \u00F7 \u00AD {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"{empty} \u00A1 {empty} \u00B3 \u00A4 {empty} {empty} {empty} {empty} {empty} {empty} \u00BF {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} \u00AE {empty} {empty} {empty} {empty} \u00D8 {empty} {empty} {empty}",
		"{lock} \u00C6 \u00A7 {empty} \u00AA {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} \u00A6 < > \u00A9 {empty} {empty} \u00BA {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Turkish Q'] = {
	...
	"alt" : [
		"< > \u00A3 # $ \u00BD {empty} { [ ] } \u005C | {bksp}",
		"{tab} @ < \u20AC  > {empty} {empty} {empty} {empty} i {empty} {empty} \u00A8 ~",
		"{lock} \u00E6 \u00DF {empty} {empty} {empty} {empty} {empty} {empty} \u00B4 {empty} ` {enter}",
		"{shift} | {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
		"{empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0130 {empty} {empty} {empty} {empty}",
		"{lock} \u00C6 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-United Kingdom'] = {
	...
	"alt" : [
		"\u00a6 {empty} {empty} {empty} \u20ac {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {bksp}",
		"{tab} {empty} {empty} \u00e9 {empty} {empty} {empty} \u00fa \u00ed \u00f3 {empty} {empty} {empty} {empty}",
		"{lock} \u00e1 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
jQuery.keyboard.layouts['ms-United Kingdom Extended'] = {
	...
	"alt" : [
		...
		"{lock} \u00e1 {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00b4 {enter}",
...
jQuery.keyboard.layouts['ms-US-Dvorak for left hand'] = {
	...
	"normal" : [
		...
		"{lock} - k c d t h e a z 8 7 {enter}",
...
jQuery.keyboard.layouts['ms-US-Dvorak for right hand'] = {
	...
	"normal" : [
		...
		"{lock} 7 8 z a e h t d c k - {enter}",
...
jQuery.keyboard.layouts['ms-Uyghur'] = {
	...
	"shift" : [
		"~ ! @ # $ % ^ & * ) ( _ + {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00bb \u00ab |",
		"{lock} {empty} \u0698 \u0641 \u06af \u062e \u062c \u06c6 \u0644\u0627 : \u0022 {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} > < / {shift}",
		"{accept} {space} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Uyghur (Legacy)'] = {
	...
	"shift" : [
		"~ ! @ # $ % ^ & * ) ( _ + {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00bb \u00ab |",
		"{lock} {empty} \u0698 \u06a7 \u06af \u062e \u062c \u06c6 \u0644\u0627 : \u0022 {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} > < / {shift}",
		"{accept} {space} {cancel}"
	]
};
...
jQuery.keyboard.layouts['ms-Uzbek Cyrillic'] = {
	...
	"normal" : [
		...
		"{lock} \u0444 \u049b \u0432 \u0430 \u043f \u0440 \u043e \u043b \u0434 \u0436 \u044d {enter}",
		"{shift} \u005c \u044f \u0447 \u0441 \u043c \u0438 \u0442 \u044c \u0431 \u044e {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
...
jQuery.keyboard.layouts['ms-Yoruba'] = {
	...
	"alt" : [
		"{empty} {empty} {empty} {empty} {empty} \u20ac {empty} {empty} {empty} \u2018 \u2019 {empty} {empty} {bksp}",
		"{tab} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty}",
		"{lock} \u1ecd\u0301 \u1ecd\u0300 {empty} {empty} {empty} {empty} {empty} \u1eb9\u0301 \u1eb9\u0300 \u00b6 {empty} {enter}",
		"{shift} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt-shift" : [
...
// Additional Language
// Croatian
jQuery.keyboard.layouts['Croatian'] = {
	"name" : "Croatian",
	"lang" : ["bs"],
	"normal" : [
		"\u00B8 1 2 3 4 5 6 7 8 9 0 ' + {bksp}",
	...
	"alt" : [
		"{empty} ~ \u02C7 ^ \u02D8 \u00B0 \u02DB ` \u02D9 \u00B4 \u02DD \u00A8 \u00B8 {bksp}",
		"{tab} \\ | \u20AC {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u00F7 \u00D7 \u00A4",
		"{lock} {empty} {empty} {empty} {empty} {empty} {empty} {empty} \u0142 \u0141 {empty} \u00DF {enter}",
		"{shift} {empty} {empty} @ { } \u00A7 {empty} < > \u00A9 {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	]
};
...
// Kurdish
jQuery.keyboard.layouts['Kurdish'] = {
	"name" : "Kurdish",
	"lang" : ["ku"],
	"normal" : [
		"\u20ac \u0661 \u0662 \u0663 \u0664 \u0665 \u0666 \u0667 \u0668 \u0669 \u0660 - = {bksp}",
		"{tab} \u0642 \u0648 \u06d5 \u0631 \u062a \u06cc \u0626 \u062d \u06c6 \u067e [ ] \\ ",
...
jQuery.keyboard.layouts['Farsi'] = {
	...
	"shift" : [
		"\u0651 ! @ # $ % ^ & * ( ) _ + {bksp}",
		"{tab} \u064e \u064b \u064f \u064c \u0644 \u0625 \u2018 \u00f7 \u00d7 \u061b < > |",
		"{lock} \u0650 \u064d ] [ \u0644 \u0623 \u0640 \u060c \\ : \u0022 {enter}",
		"{shift} ~ \u0652 } { \u0644 \u0622 \u0621 . \u061f {empty} {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"alt" : [
		"{empty} \u00a1 \u00b2 \u00b3 \u00a4 \u20ac \u00bc \u00bd \u00be \u2018 \u2019 \u00a5 \u00d7 {bksp}",
...
// Amheric
jQuery.keyboard.layouts['Amharic'] = {
	'name' : 'Amharic',
	'lang' : ['amh'],
	'normal': [
		'` \u1369 \u136A \u136B \u136C \u136D \u136E \u136F \u1370 \u1371 ፈ \u1365 = {bksp}',
		'{tab} \u1240 \u12c8  ኘ \u1228 \u1270 \u12e8 ተ ለ ረ \u1330 \u1248 \u1288 \\',
		'{lock} ኣ \u1230 \u12f0 \u1348 \u1308 \u1200 \u1338 \u12a8 \u1208:Shortcut_(l_+_e_=_\u120d) ; \u12a0 {enter}',
		'{shift} \u12d8 \u1280 \u1278 \u1238 \u1260 \u1290 \u1218 \u1361 \u1362 / {shift}',
		'{accept} {alt} {space} {alt} {cancel}'
	],
	'shift': [
		'~ \u1372 \u1373 \u1374 \u1375 \u1376 \u1377 \u1378 \u1379 \u137A \u137B \u137C + {bksp}',
		'{tab} \u1250 \u12d0  ነ \u122f \u1320 ጨ ፀ ጸ ኀ \u1350 \u1310 \u12b0 \u1384',
		'{lock} \u0101 \u1220 \u1300 \u1358 \u1318 \u1210 \u1340 \u12b8 \u12f8 \u12A5\u130D\u12DA\u12A0\u1265\u1214\u122D\u1361 " {enter}',
	...
	'alt': [
		...
		'{lock} a \u0161 d f \u01e7 \u1e2b j k l ; \u02be {enter}',
	...
	'alt-shift': [
		...
		'{lock} A \u0160 D F \u01e6 \u1e2a J K L : \u02bf {enter}',
		'{shift} \u017d X \u010c\u0323 \u010c B \u00d1 M < > ? {shift}',
		'{accept} {alt} {space} {alt} {cancel}'
	]
};
...
// Amheric
jQuery.keyboard.layouts['Akan'] = {
	'name' : 'Akan',
	'lang' : ['ak'],
	"normal" : [
		"` 1 2 3 4 5 6 7 8 9 0 - = {bksp}",
		"{tab} ɛ w e r t y u i o p q c \u005C",
		"{lock} a s d f g h j k l ; ' {enter}",
		"{shift} z x  ɔ v b n m , . / {shift}",
		"{accept} {alt} {space} {alt} {cancel}"
	],
	"shift" : [
		"~ ! @ # $ % ^ & * ( ) _ + {bksp}",
